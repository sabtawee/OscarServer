...
/// Submit a macro verification to a player ({<char id>})
BUILDIN_FUNC( check_macro )
{
	struct map_session_data* sd;
...
/*==========================================
 * costume collection get costume type
 *------------------------------------------*/
...
/*==========================================
 * costume collection custom callshop
 *------------------------------------------*/
...
/*==========================================
 * statusmes with purple text
 *------------------------------------------*/
BUILDIN_FUNC(purplemes)
{
	const char *str;
	str=script_getstr(st,2);
	ShowStatus(CL_LT_MAGENTA "%s\n" CL_CLL,str);
	return SCRIPT_CMD_SUCCESS;
}

/*==========================================
 * statusmes with yellow text
 *------------------------------------------*/
BUILDIN_FUNC(yellowmes)
{
	const char *str;
	str=script_getstr(st,2);
	ShowStatus(CL_LT_YELLOW "%s\n" CL_CLL,str);
	return SCRIPT_CMD_SUCCESS;
}

/*==========================================
 * statusmes with red text
 *------------------------------------------*/
BUILDIN_FUNC(redmes)
{
	const char *str;
	str=script_getstr(st,2);
	ShowStatus(CL_LT_RED "%s\n" CL_CLL,str);
	return SCRIPT_CMD_SUCCESS;
}

/*==========================================
 * force BL/PC recalculate status
 *------------------------------------------*/
BUILDIN_FUNC(pc_force_recalc)
{
	struct map_session_data* sd;
...
// <--- [zBuffer] List of unit control commands
	...
	BUILDIN_DEF(purplemes,"s"),
	BUILDIN_DEF(yellowmes,"s"),
	BUILDIN_DEF(redmes,"s"),
	
	BUILDIN_DEF(pc_force_recalc,""),
