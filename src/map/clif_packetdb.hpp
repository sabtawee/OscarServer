...
// 2016-03-02bRagexe
	...
	parseable_packet( HEADER_CZ_CAPTCHA_REGISTER, sizeof( PACKET_CZ_CAPTCHA_REGISTER ), clif_parse_captcha_register, 0 );
	packet(HEADER_ZC_CAPTCHA_UPLOAD_REQUEST, sizeof( PACKET_ZC_CAPTCHA_UPLOAD_REQUEST ));
	parseable_packet( HEADER_CZ_CAPTCHA_UPLOAD_REQUEST_ACK, -1, clif_parse_captcha_upload, 0 );
	packet(HEADER_ZC_CAPTCHA_UPLOAD_REQUEST_STATUS, sizeof( PACKET_ZC_CAPTCHA_UPLOAD_REQUEST_STATUS ));
	parseable_packet( HEADER_CZ_MACRO_REPORTER_ACK, sizeof( PACKET_CZ_MACRO_REPORTER_ACK ), clif_parse_macro_reporter_ack, 0 );
	packet(HEADER_ZC_MACRO_REPORTER_STATUS, sizeof( PACKET_ZC_MACRO_REPORTER_STATUS ));
	packet(HEADER_ZC_MACRO_DETECTOR_REQUEST, sizeof( PACKET_ZC_MACRO_DETECTOR_REQUEST ));
	packet(HEADER_ZC_MACRO_DETECTOR_REQUEST_DOWNLOAD, -1);
	parseable_packet( HEADER_CZ_MACRO_DETECTOR_DOWNLOAD, sizeof( PACKET_CZ_MACRO_DETECTOR_DOWNLOAD ), clif_parse_macro_detector_download_ack, 0 );
	packet(HEADER_ZC_MACRO_DETECTOR_SHOW, sizeof( PACKET_ZC_MACRO_DETECTOR_SHOW ));
	parseable_packet( HEADER_CZ_MACRO_DETECTOR_ANSWER, sizeof( PACKET_CZ_MACRO_DETECTOR_ANSWER ), clif_parse_macro_detector_answer, 0 );
	packet(HEADER_ZC_MACRO_DETECTOR_STATUS, sizeof( PACKET_ZC_MACRO_DETECTOR_STATUS ));
#endif
#if PACKETVER >= 20160323
	parseable_packet( HEADER_CZ_CAPTCHA_PREVIEW_REQUEST, sizeof( PACKET_CZ_CAPTCHA_PREVIEW_REQUEST ), clif_parse_captcha_preview_request, 0 );
	packet(HEADER_ZC_CAPTCHA_PREVIEW_REQUEST, sizeof( PACKET_ZC_CAPTCHA_PREVIEW_REQUEST ));
	packet(HEADER_ZC_CAPTCHA_PREVIEW_REQUEST_DOWNLOAD, -1);
#endif
#if PACKETVER >= 20160330
	parseable_packet( HEADER_CZ_MACRO_REPORTER_SELECT, sizeof( PACKET_CZ_MACRO_REPORTER_SELECT ), clif_parse_macro_reporter_select, 0 );
	packet(HEADER_ZC_MACRO_REPORTER_SELECT, -1);
#endif
